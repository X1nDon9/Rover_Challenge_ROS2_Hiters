...
OBJS += \
./Devices/Serial/Serial.o 

C_DEPS += \
./Devices/Serial/Serial.d 


# 每个子目录必须为构建它所贡献的源提供规则
Devices/Serial/%.o Devices/Serial/%.su Devices/Serial/%.cyclo: ../Devices/Serial/%.c Devices/Serial/subdir.mk
...
clean: clean-Devices-2f-Serial

clean-Devices-2f-Serial:
	-$(RM) ./Devices/Serial/Serial.cyclo ./Devices/Serial/Serial.d ./Devices/Serial/Serial.o ./Devices/Serial/Serial.su

.PHONY: clean-Devices-2f-Serial
