...
int main(int argc, char **argv)
{
	...
	node_lidar.lidar_general_info.port = node->declare_parameter("port", node_lidar.lidar_general_info.port);
	
	node_lidar.lidar_general_info.m_SerialBaudrate = node->declare_parameter("baudrate", node_lidar.lidar_general_info.m_SerialBaudrate);

	node_lidar.lidar_general_info.frame_id = node->declare_parameter("frame_id", node_lidar.lidar_general_info.frame_id);
	
	node_lidar.lidar_general_info.version = node->declare_parameter("version", node_lidar.lidar_general_info.version);
